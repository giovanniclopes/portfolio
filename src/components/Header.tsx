...
import { List, X, LinkedinLogo, GithubLogo , EnvelopeSimple } from "phosphor-react";
  ...
  return (
    <header>
      <nav
        className={
          fix
            ? "z-50 fixed top-0 w-full flex items-center justify-between h-max py-7 px-8 mx-auto bg-gray-500 text-white text-sm font-semibold transition-all md:items-center mbl:px-4"
            : "z-50 fixed top-0 w-full flex items-center justify-between h-24 py-3 px-8 mx-auto backdrop-blur-0 bg-gray-600/20 text-xs font-medium text-white/50 transition-all md:items-center mbl:px-4"
        }
      >
        {/* <Link to="/">
          <img
        ...
        <div className="flex gap-5">
          ...
          <NavLink to="emailto:giovanniclopes@gmail.com">
            <EnvelopeSimple width={26} height={26} />
          </NavLink>
        </div>
        <button
